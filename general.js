...
function getItems() {
    ...
    if (req.readyState == 4) {
		...
		for(i=0;i<items.length;i++){
		  ...
		  var iuqty = items[i].getElementsByTagName("qty")[0].firstChild.nodeValue;
...
cell3.innerHTML='<input type="text" name="itemstax[]" value="'+tax+'"><input type="hidden" name="itemstotaltax[]" value="0">';
