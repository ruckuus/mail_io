...
if(isset($_POST['adminlogin'])){
	...
	$result = $db->query("select * from hp_reseller where kode_reseller='" .trim($_POST['adminname']) ."' and hp='" .trim($_POST['adminpassword']) ."'");
	//IF LOGIN OK
...
<table>
<TR>
<TD><a href="admin.php?action=categories"><?php echo ADMINMENU_CURRENCIES; ?></a></TD>
<TD><a href="admin.php?action=country"><?php echo ADMINMENU_COUNTRY; ?></a></TD>
<TD><a href="admin.php?action=banks"><?php echo ADMINMENU_BANKS; ?></a></TD>
<TD><a href="admin.php?action=bank_accounts"><?php echo ADMINMENU_BANK_ACC; ?></a></TD>
...
<TD><a href="admin.php?action=beli"><?php echo ADMINMENU_BELI; ?></a></TD>
<TD><a href="admin.php?action=jual"><?php echo ADMINMENU_SALES; ?></a></TD>
...
?>
<center>	<img src="images/front.png"></center>
	</div><?php
}
...
if($_GET['action']=="bank_accounts"){
require_once("bank_accounts.php");
}
