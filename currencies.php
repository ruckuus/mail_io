...
?>
<form action="admin.php?action=categories" onsubmit="validate_form(this)" enctype="multipart/form-data" method="post">
...
?>
<form action="admin.php?action=categories" onsubmit="validate_edit_form(this)" enctype="multipart/form-data" method="POST">
<table>
...
?>
<TR><TD class="btvalue"><a href="admin.php?action=products&category=<?php echo $row[0]; ?>"><?php echo htmlspecialchars($row[1]); ?></a></TD><TD class="tvalue" align="center"><a href="admin.php?action=currencies&edit=<?php echo $row[0]; ?>"><img src="images/edit.gif"></a></TD><TD class="tvalue" align="center"><a href="admin.php?action=currencies&delete=<?php echo $row[0]; ?>"><img src="images/delete.gif"></a></TD></TR>
<?php
} 
?>
</table>
