...
$sql = "update customers set first_name='" .$_POST['firstname'] ."', last_name='" .$_POST['lastname'] ."', address='" .$_POST['address'] ."', city='" .$_POST['city'] ."', pcode='" .$_POST['pcode'] ."', state='" .$_POST['state'] ."', country='" .$_POST['country'] ."', phone_number='" .$_POST['phone_number'] ."', email='" .$_POST['email'] ."', comments='" .$_POST['comments'] ."' where id=" .$_POST['customer_id'];
$db->query($sql);
}
...
<table>
<TR><TD><?php echo TXT_ACCOUNT_NUMBER; ?></TD><TD><input type="hidden" name="account_number" value="<?php echo $cust_acc;?>"> <?php echo $cust_acc;?></TD></TR>
...
<?php
$resultx = $db->query("select id,country from country");
while($country = mysql_fetch_row($resultx)){
?><option value="<?php echo $country[0]; ?>"><?php echo $country[1]; ?></option><?php
}
?>
</select>
</TD></TR>
...
<table>
<TR><TD><?php echo TXT_ACCOUNT_NUMBER; ?></TD><TD><?php echo htmlspecialchars($row[3]); ?></TD></TR>
...
$resultx = $db->query("select id,country from country");
while($country = mysql_fetch_row($resultx)){
?><option value="<?php echo $country[0]; ?>" <?php if(isset($_GET['edit_customer']) && $row[8]==$country[0]) echo "SELECTED"; ?>><?php echo $country[1]; ?></option><?php
}
?>
</select>
</TD></TR>
...
?>
<TR><TD class="tvalue">&nbsp;</TD><TD class="tvalue"><?php echo htmlspecialchars($row[1] ." " .$row[2]); ?></TD><TD class="tvalue"><?php echo htmlspecialchars($row[9]); ?>&nbsp;</TD><TD class="tvalue"><?php echo htmlspecialchars($row[10]); ?>&nbsp;</TD><TD class="tvalue" align="center"><A href="admin.php?action=clients&#038;edit_customer=<?php echo $row[0]; ?>"><img src="images/edit.gif"></A></TD><TD class="tvalue" align="center"><A href="javascript:delete_customer(<?php echo $row[0]; ?>)"><img src="images/delete.gif"></A></TD></TR>
<?php
}
?>
</table>
